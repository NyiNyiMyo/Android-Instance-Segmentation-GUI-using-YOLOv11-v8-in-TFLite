...
class InstanceSegmentation(
    ...
    internal var tensorWidth = 0
    internal var tensorHeight = 0
    ...
    fun invoke(frame: Bitmap) {
        ...
        val segmentationResults = if (bestBoxes.isNullOrEmpty()) {
            // No detections: create empty list, original frame will be used in overlay
            emptyList()
        } else {
